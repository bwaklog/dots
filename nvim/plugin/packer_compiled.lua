...
_G.packer_plugins = {
  ...
  harpoon = {
    loaded = true,
    path = "/Users/adityahegde/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  ["noice.nvim"] = {
    loaded = true,
    path = "/Users/adityahegde/.local/share/nvim/site/pack/packer/start/noice.nvim",
  ...
  ["nvim-notify"] = {
    loaded = true,
    path = "/Users/adityahegde/.local/share/nvim/site/pack/packer/start/nvim-notify",
  ...
  orgmode = {
    ...
    loaded = true,
    path = "/Users/adityahegde/.local/share/nvim/site/pack/packer/start/orgmode",
  ...
  vimtex = {
    loaded = true,
    path = "/Users/adityahegde/.local/share/nvim/site/pack/packer/start/vimtex",
